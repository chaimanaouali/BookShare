...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card">
    <div class="card-header">
      <h5 class="mb-0">Create new challenges</h5>
    </div>
    <div class="card-body">
      <x-validation-helper formId="challengeForm" />
      
      <form method="POST" action="{{ route('defis.store') }}" class="needs-validation" novalidate id="challengeForm" data-validate>
        @csrf
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <textarea 
              ...
              placeholder="Description détaillée du défi...">{{ old('description') }}</textarea>
            @error('description')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
...
<script>
// Enhanced challenge form validation
