...
@section('title', 'Ajouter Avis - Admin')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Ajouter un Nouvel Avis</h5>
                    ...
                    <form action="{{ route('admin.avis.store') }}" method="POST">
                                    ...
                                    <select class="form-select @error('utilisateur_id') is-invalid @enderror" 
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->id }}" 
                                                    {{ old('utilisateur_id') == $user->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Laisser vide pour utiliser la date d'aujourd'hui</div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-save me-1"></i> Créer l'Avis
                            </button>
                        </div>
                    </form>
                </div>
