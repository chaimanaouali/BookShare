...
@section('title', $bibliotheque->nom_bibliotheque . ' - Admin')
  ...
  <div class="col-12">
    <div class="d-flex justify-content-between align-items-center">
      <div>
        ...
        <p class="text-muted">{{ $bibliotheque->nb_livres }} books • Created {{ $bibliotheque->created_at->diffForHumans() }} • Owner: {{ $bibliotheque->user->name ?? 'Unknown' }}</p>
      </div>
      <div class="d-flex gap-2">
        <a href="{{ route('admin.bibliotheques.add-books', $bibliotheque->id) }}" class="btn btn-primary">
          <i class="bx bx-plus me-1"></i> Add Books
        </a>
        <a href="{{ route('admin.bibliotheques.edit', $bibliotheque->id) }}" class="btn btn-outline-primary">
      ...
      <div class="card-body">
        ...
        @else
          <div class="text-center py-5">
            ...
            <p class="text-muted mb-4">Add books to start building this library</p>
            <a href="{{ route('admin.bibliotheques.add-books', $bibliotheque->id) }}" class="btn btn-primary">
