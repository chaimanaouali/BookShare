                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                            <h6>BookShare</h6>
                            <h2>Modifier l'<em>Emprunt</em> #{{ $emprunt->id }}</h2>
                            <p>Modifiez les informations de votre emprunt de livre.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                            <img src="{{ asset('assets/images/banner-right-image.png') }}" alt="edit emprunt">
                        </div>
                    </div>
                </div>
            </div>
...
<div id="edit-emprunt" class="about-us section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    <h2>Modifier l'Emprunt #{{ $emprunt->id }}</h2>
                    <p>Modifiez les informations de votre emprunt</p>
                </div>
            </div>
        </div>
