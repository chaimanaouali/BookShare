...
@section('title', 'Edit Library - BookShare')
  ...
  <div class="col-12">
    <div class="d-flex justify-content-between align-items-center">
      <div>
        ...
        <p class="text-muted">Update your library information</p>
      </div>
      <a href="{{ route('contributor.bibliotheques.show', $bibliotheque->id) }}" class="btn btn-outline-secondary">
...
<div class="row">
  <div class="col-lg-8">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('contributor.bibliotheques.update', $bibliotheque->id) }}" method="POST">
          @csrf
          @method('PUT')
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row text-center mb-3">
          ...
          <div class="col-6">
            <div class="h4 text-success mb-0">{{ $bibliotheque->created_at->format('M d') }}</div>
    ...
    <div class="card mt-3">
      ...
      <div class="card-body">
        <div class="d-grid gap-2">
          <a href="{{ route('contributor.bibliotheques.show', $bibliotheque->id) }}" class="btn btn-outline-primary btn-sm">
            <i class="bx bx-show me-1"></i> View Library
          </a>
          <a href="{{ route('contributor.livres.create', ['bibliotheque' => $bibliotheque->id]) }}" class="btn btn-outline-success btn-sm">
            <i class="bx bx-plus me-1"></i> Add Book
          </a>
          <a href="{{ route('contributor.bibliotheques.index') }}" class="btn btn-outline-secondary btn-sm">
