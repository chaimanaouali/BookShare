...
@section('title', 'Add Books to Library - BookShare')
  ...
  <div class="col-12">
    <div class="d-flex justify-content-between align-items-center">
      <div>
        ...
        <p class="text-muted">Select books from your collection to add to this library</p>
      </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        @if($availableBooks->count() > 0)
          <form action="{{ route('contributor.bibliotheques.store-books', $bibliotheque->id) }}" method="POST" id="bookSelectionForm">
            @csrf
        ...
        @else
          <div class="text-center py-5">
            ...
            <p class="text-muted">All your books are already in this library.</p>
            <div class="mt-4">
              <a href="{{ route('contributor.bibliotheques.show', $bibliotheque->id) }}" class="btn btn-outline-secondary">
                <i class="bx bx-arrow-back me-1"></i> Back to Library
              </a>
