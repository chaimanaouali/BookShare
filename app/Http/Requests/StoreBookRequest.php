...
class StoreBookRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bibliotheque_id' => [
                'required',
                'exists:bibliotheque_virtuelles,id',
                Rule::exists('bibliotheque_virtuelles', 'id')->where('user_id', auth()->id()),
            ],
            'fichier_livre' => [
                'required',
                'file',
    ...
    public function messages(): array
    {
        return [
            ...
            'bibliotheque_id.required' => 'La bibliothèque est obligatoire.',
            'bibliotheque_id.exists' => 'La bibliothèque sélectionnée n\'existe pas ou ne vous appartient pas.',
            
            'fichier_livre.required' => 'Le fichier du livre est obligatoire.',
